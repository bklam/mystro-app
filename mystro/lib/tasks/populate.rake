namespace :db do
  ...
  task :populate => :environment do
    ...
    candace = Student.new
    candace.first_name = "Candace"
    candace.last_name = "Campbell"
    candace.date_of_birth = Date.new(1994, 3, 11)
    candace.date_started = Date.new(2014, 9, 27)
    # NULL date_ended
    candace.email = "candaceecampbell@gmail.com"
    candace.phone = "7175278490"
    candace.outstanding_balance = 0
    candace.save!
